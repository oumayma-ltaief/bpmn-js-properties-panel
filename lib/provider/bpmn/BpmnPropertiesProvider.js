...
var processProps = require('./parts/ProcessProps'),
    ...
    variablesProcess = require('./parts/VariablesProcess');
...
function createPropertiesTabGroups(element, bpmnFactory, elementRegistry, translate) {
  ...
  variablesProcess(propertiesGroup, element, bpmnFactory, translate);
...
function BpmnPropertiesProvider(eventBus, bpmnFactory, elementRegistry, translate) {
  ...
  this.getTabs = function(element) {
    ...
    var propertiesTab = {
      id: 'properties',
      label: translate('Properties'),
      groups: createPropertiesTabGroups(element, bpmnFactory, elementRegistry, translate)
    }
